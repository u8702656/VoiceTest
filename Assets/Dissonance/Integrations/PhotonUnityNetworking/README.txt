Dissonance Photon Unity Networking (Classic) Integration
========================================================

This package integrates Dissonance Voice Chat (https://assetstore.unity.com/packages/tools/audio/dissonance-voice-chat-70078?aid=1100lJDF) with the Photon Unity Networking (Classic) networking system (https://assetstore.unity.com/packages/tools/network/photon-unity-networking-classic-free-1786?aid=1100lJDF). To use this package you must have purchased and installed Dissonance and PUN - **you will encounter build errors until you have done this**!

The included demo scene (Assets/Dissonance/Integrations/PhotonUnityNetworking/Demo/PUN Demo) demonstrates the basics of a voice chat session running in a PUN network session. Consult the readme file in the demo folder for details on how to run the demo and what features it demonstrates.
